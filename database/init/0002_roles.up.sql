...
GRANT USAGE ON SCHEMA idp, public TO idp_administrator_role;
GRANT USAGE ON SCHEMA idp, public TO idp_read_write_role;
GRANT USAGE ON SCHEMA idp, public TO idp_read_only_role;

-- GRANT ALL ON ADMIN ROLE; this is migration user
GRANT ALL ON SCHEMA idp TO idp_administrator_role;
...
ALTER ROLE idp_administrator_role SET search_path TO idp, public;
ALTER ROLE idp_read_write_role SET search_path TO idp, public;
ALTER ROLE idp_read_only_role SET search_path TO idp, public;
